...
#Инициализация функции Tanh
def tanh(x):
    return np.tanh(x)

#Направление функции Tanh
...
def train_model():
    ...
    for epoch in range(epochs):
        ...
        for i in range(0, sensors_train.shape[0], batch_size):
            ...
            d_hidden1 = np.dot(weights_hidden1_to_output.T, d_output) * tanh_derivative(hidden1_raw)
        ...
        hidden1_test = tanh(hidden1_raw_test)
    ...
    np.savez('trained_model_5epoh.npz',
