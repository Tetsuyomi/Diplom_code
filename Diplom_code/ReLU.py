...
#     with np.load('dataset/data1.npz') as f1:
...
#     with np.load('dataset/data2.npz') as f2:
#         y_train = f2['y_train']
#
...
#          bias_hidden1_to_hidden2=bias_hidden1_to_hidden2,
#          bias_hidden_to_output=bias_hidden_to_output)
#
# print('Модель сохранена в файл trained_model.npz')
...
#
#     weights_input_to_hidden1 = np.random.normal(0, 0.1, (hidden_size1, input_size))
#     weights_hidden1_to_hidden2 = np.random.normal(0, 0.1, (
#     hidden_size2, hidden_size1))  # Веса между первым и вторым скрытым слоем
#     weights_hidden2_to_output = np.random.normal(0, 0.1, (output_size, hidden_size2))
#
#     bias_input_to_hidden1 = np.zeros((hidden_size1, 1))
#     bias_hidden1_to_hidden2 = np.zeros((hidden_size2, 1))  # Смещение для второго скрытого слоя
...
#         hidden2_raw_test = np.dot(weights_hidden1_to_hidden2, hidden1_test) + bias_hidden1_to_hidden2
#         hidden2_test = relu(hidden2_raw_test)
#         output_raw_test = np.dot(weights_hidden2_to_output, hidden2_test) + bias_hidden_to_output
...
#
#         print(f'Epoch {epoch + 1}, Loss: {loss}, Test Loss: {test_loss}, Test Accuracy: {accuracy}')
#
...
#     weights_hidden1_to_hidden2 = model['weights_hidden1_to_hidden2']
#     weights_hidden2_to_output = model['weights_hidden2_to_output']
#     bias_input_to_hidden1 = model['bias_input_to_hidden1']
#     bias_hidden1_to_hidden2 = model['bias_hidden1_to_hidden2']
